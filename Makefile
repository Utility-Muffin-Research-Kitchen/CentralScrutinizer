...
SRC_COMMON := src/build_info.c src/paths.c src/auth.c src/session.c src/catalog.c src/rom_policy.c src/platforms.c src/states.c src/dotclean.c src/art.c src/library.c src/uploads.c src/file_ops.c src/settings.c src/keep_awake.c src/ui.c
