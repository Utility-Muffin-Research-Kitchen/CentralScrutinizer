...
static const cs_platform_info g_platforms[] = {
    ...
    {.tag = "SFC_JP",
     ...
     .icon = "SNES",
     .primary_code = "SFC_JP",
     .rom_directory = "Super Famicom (SFC_JP)"},
    {.tag = "N64",
     .name = "Nintendo 64",
     .group = "Nintendo",
     .icon = "N64",
     .primary_code = "N64",
     .rom_directory = "Nintendo 64 (N64)"},
    {.tag = "SGB",
     .name = "Super Game Boy",
     .group = "Nintendo",
     .icon = "GB",
    ...
    {.tag = "SATURN",
     ...
     .icon = "SATURN",
     .primary_code = "SATURN",
     .rom_directory = "Sega Saturn (SATURN)"},
    {.tag = "DC",
     .name = "Dreamcast",
     .group = "Sega",
     .icon = "DC",
     .primary_code = "DC",
     .rom_directory = "Dreamcast (DC)"},
    {.tag = "PS",
    ...
    {.tag = "PCECD",
     ...
     .icon = "PCE",
     .primary_code = "PCECD",
     .rom_directory = "TurboGrafx-CD (PCECD)"},
    {.tag = "WS",
     .name = "WonderSwan",
     .group = "Bandai",
     .icon = "WS",
     .primary_code = "WS",
     .rom_directory = "WonderSwan (WS)"},
    {.tag = "WSC",
     .name = "WonderSwan Color",
     .group = "Bandai",
     .icon = "WSC",
     .primary_code = "WSC",
     .rom_directory = "WonderSwan Color (WSC)"},
    {.tag = "COLECO",
     .name = "Colecovision",
     .group = "Other",
     .icon = "COLECOVISION",
